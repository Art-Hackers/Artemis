...
from .theme import build_theme, resolve_color
...
class App:
    ...
    def _build_nav_bar(self):
        ...
        return ft.NavigationBar(
            ...
            bgcolor=resolve_color(self.surface) if self.surface else None,
        )
    ...
    def _build_view(self, route, is_root):
        ...
        if entry["appbar"]:
            appbar = ft.AppBar(
                title=ft.Text(entry["title"] or self.title),
                bgcolor=resolve_color(self.surface) if self.surface else None,
            )
        ...
        return ft.View(
            ...
            bgcolor=resolve_color(self.background) if self.background else None,
        )
